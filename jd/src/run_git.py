...
def preview_cal():
    ...
    thus = [job_posi, job_summ[0], job_resp_lst,
...
def preview():
    ...
    return render_template("preview.html",thus = thus, job_posi=thus[0],
                           job_summ=thus[1],job_resp=thus[2], tit=thus[3], val4=thus[4],
                           job_degr=thus[5],job_majo=thus[6], job_mino=thus[7],
                           deg_val=thus[8],job_minn=thus[9], job_expr=thus[10],
                           job_back=thus[11], job_lst=thus[12],job_main=thus[13],
                           job_pref=thus[14], job_capa=thus[15],job_cert=thus[16],
                           job_port=thus[17], job_all = thus[18])
